...
public class ReportData {
    ...
    public final static String NO_JAK2_COMMENT_TEXT = "Отрицательный результат определения мутации V617F в 14 экзоне гена JAK2 не исключает наличие других драйверных мутаций, характерных для МПН: в 12 экзоне гена JAK2, 9 экзоне гена CALR и 515 кодоне гена MPL.";
